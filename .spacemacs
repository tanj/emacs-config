...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-themes '((zenburn :location (recipe :fetcher github
...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  ...
  (load "~/.emacs.d/private/tanj/userinit.el")
  )
...
before packages are loaded."
  (load "~/.emacs.d/private/tanj/misc.el")
  (load "~/.emacs.d/private/tanj/html.el")
  (load "~/.emacs.d/private/tanj/global.el")
  (load "~/.emacs.d/private/tanj/gnus.el")
  ;; Custom key bindings
  ...
  (global-set-key "\C-x%" 'jt/literal-replace-regexp)
  (global-set-key "\C-s" 'isearch-forward-regexp)
  (global-set-key "\C-r" 'isearch-backward-regexp)
  (global-set-key "\M-Q" 'jt/unfill-paragraph)
